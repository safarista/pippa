...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<oa-oauth>, ["= 0.2.3"])
      s.add_runtime_dependency(%q<oa-basic>, ["= 0.2.3"])
      s.add_runtime_dependency(%q<oa-openid>, ["= 0.2.3"])
      s.add_runtime_dependency(%q<oa-enterprise>, ["= 0.2.3"])
      s.add_runtime_dependency(%q<oa-more>, ["= 0.2.3"])
      ...
      s.add_dependency(%q<oa-oauth>, ["= 0.2.3"])
      s.add_dependency(%q<oa-basic>, ["= 0.2.3"])
      s.add_dependency(%q<oa-openid>, ["= 0.2.3"])
      s.add_dependency(%q<oa-enterprise>, ["= 0.2.3"])
      s.add_dependency(%q<oa-more>, ["= 0.2.3"])
